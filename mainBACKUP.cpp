...
int main() {
    ...
    if(mpu6050.calibrate()){
        //printf("MPU6050 ERREUR DURANT CALIBRATION");
        return 1;
    }
    ...
    else
    {
        ...
        {
            qmc5883l.setCalibration({ {-42.000928, 
                                        -139.886756,
                                        692.734686 },
                                   {{   0.831577,   -0.025989,  -0.010617},
                                    {  -0.025989,   0.789502,   -0.033483},
                                    {  -0.010617,    -0.033483,   0.850817} }});
            ...
            //qmc5883l.setCalibration({ {87.852962, 
            //                            -11.377609,
            //                            557.383102 },
            //                       {{   0.756730,   -0.013820,  -0.017384},
            //                        {  -0.013820,   0.649565,   -0.016060},
            //                        {  -0.017384,    -0.016060,   0.613090} }});
    ...
    while (true) {
        ...
        //acc_x_f = acc_x * SENSITIVITY_2G * EARTH_GRAVITY;dwwwwww
        //acc_y_f = acc_y * SENSITIVITY_2G * EARTH_GRAVITY;
        //acc_z_f = acc_z * SENSITIVITY_2G * EARTH_GRAVITY;

        // Print results
        //printf("Rate_X (°/s): %.2f | Rate_Y (°/s): %.2f | Rate_Z (°/s): %.2f\r\n", mpu6050.rateRoll, mpu6050.ratePitch, rateYaw);
